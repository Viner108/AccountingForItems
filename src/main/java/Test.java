...
public class Test {
    public static void main(String[] args) throws IOException {
        ...
        application.getTable().insert(application.getComputer(),application.loginUser("X","Y"),application.getLog());
        ...
        application.searchInThisRoom(application.getDress(),application.loginUser("X2","Y2"),application.getFloor(),application.getBed(),application.getTable(),application.getArmchair(),application.getSuitcase());
